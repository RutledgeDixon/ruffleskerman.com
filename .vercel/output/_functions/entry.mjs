...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_DjHlD5Xc.mjs';
import { manifest } from './manifest_o1RDzVE1.mjs';
...
const _args = {
    "middlewareSecret": "9220bf07-ce8e-4a4a-ad0e-6fddc20aceb9",
