...
// Re-exported for backward compatibility - these are pure helpers with no
// Node dependency, defined in ruruProtocol.js so browser code (ruruWebClient.js)
// can import them without pulling in node:net.
export {
	RURU_DEFAULT_PORT,
	RURU_MAX_CLIENTS,
	RURU_ID_PREFIX,
